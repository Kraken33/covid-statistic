...
const FullStatisticContainer = ()=>{
    // @TODO Solve it
    const [{statistic, pending}, dispatch] = useReducer<Reducer<any, any>, IStatisticData>(reducer, { statistic: null, pending: false }, (s)=>s);
