...
const FullStatisticComponent: React.FC<IProps> = ({
  statistic,
  payloadFull,
}) => {
  ...
  const allCases = [
    {
      ...
      icon: (
        <CheckIcon fontSize="large" color="inherit" style={{ color: "#FFF" }} />
      ),
    },
    {
      label: "Death",
      ...
      icon: (
        <InfoIcon fontSize="large" color="inherit" style={{ color: "#FFF" }} />
      ),
    },
    {
      label: "Recovered",
          ...
          <Grid item xs>
            ...
            >
              <Grid container justify="space-between">
                <Grid item>
                  <div
                    className="big-badge big-badge--float"
                    style={{ background: statistic.color + "80" }}
                  >
                    {statistic.icon}
                  </div>
                </Grid>
      ...
      <Grid container>
        <Grid item style={{ margin: "0 auto", marginTop: 50 }}>
          ...
          >
            ...
            <Bar
              dataKey="confirmed"
              fill={statusBadgeColors.confirmed + "80"}
            />
            <Bar dataKey="deaths" fill={statusBadgeColors.deaths + "80"} />
            <Bar
              dataKey="recovered"
              fill={statusBadgeColors.recovered + "80"}
            />
          </BarChart>
        </Grid>
      </Grid>
